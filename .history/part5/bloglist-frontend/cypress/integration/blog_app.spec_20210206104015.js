	...
	describe('When logged in', function () {
		...
		describe.only('when multiples blogs exist', function () {
			...
			it('blogs order', function () {
				...
				cy.get('@iitem0').contains('View').click()
				cy.get('@iitem0').contains('Add Like').click()

				cy.get('@iitem1').contains('View').click()
				cy.get('@iitem1').contains('Add Like').click()
				cy.get('@iitem1').contains('Add Like').click()
				cy.get('@iitem1').contains('Add Like').click()

				cy.get('@iitem2').contains('View').click()
				cy.get('@iitem2').contains('Add Like').click()
				cy.get('@iitem2').contains('Add Like').click()
